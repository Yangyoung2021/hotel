                    ...
                    <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <label for="iconPicker"></label><input type="text" name="iconFa" id="iconPicker" lay-filter="iconPicker" autocomplete="off" placeholder="请输入菜单图标" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
...
<script>
    layui.extend({
        ...
        var tableIns = table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/admin/menu/findAllMenu',
            toolbar: '#toolbarDemo',
            cols: [[
                ...
                {field: 'spread', width: 100, title: '是否展开',align: 'center',templet:function(d) {
                        return d.spread  === 1 ? "<span color='red'>是</span>" : "<span color='blue'>否</span>";
                    }},
        ...
        function deleteById(data) {
            $.get("/admin/menu/checkMenuHasChild",{"id":data.id},function(result){
                ...
                if(result.exist){
                    ...
                    //提示用户是否删除该菜单
                    layer.confirm("确定要删除[<span style='color: red'>"+data.title+"</span>]吗", {icon: 3, title:'提示'}, function(index){
                        //发送ajax请求进行删除
