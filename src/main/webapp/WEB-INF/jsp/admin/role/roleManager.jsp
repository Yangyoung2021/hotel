        ...
        <div style="display: none;padding: 5px" id="addOrUpdateWindow">
            <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <label for="roleDesc"></label><textarea class="layui-textarea" name="roleDesc" id="roleDesc"></textarea>
                    </div>
                </div>
...
<script>
    layui.extend({
        ...
        let tableIns = table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/admin/role/findRoleList',
            toolbar: '#toolbarDemo',
            cols: [[
        ...
        function deleteById(data){
            ...
            $.get("/admin/role/checkRoleEmployee",{"roleId":data.id},function (result){
                if(result.exist){
                    ...
                    //不存在员工，提示用户是否确定删除员工
                    layer.confirm("确定要删<span style='color: red'>"+data.roleName+"</span>吗",function (index){
                        //用户确定删除
                        $.get("/admin/role/deleteRole",{"roleId":data.id},function (result){
                            if (result.success){
                                //删除成功
                                tableIns.reload();
                            }
        ...
        function openGrantMenuWindow(data) {
            mainIndex = layer.open({
                type: 1,//打开类型
                title: "分配[<span style='color: red'>"+data.roleName+"</span>]的菜单",//窗口标题
