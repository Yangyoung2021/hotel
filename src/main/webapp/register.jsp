                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline iphone">
                                    <div class="layui-input-inline">
                                        ...
                                        <label for="mNickname"></label><input type="text" name="loginName" id="mNickname" lay-verify="required" lay-reqText="请输入昵称" placeholder="请输入昵称" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
    ...
    layui.use(["form","element","carousel"], function () {
        ...
        $(function (){
            ...
            $("#mNickname").blur(function () {
                let name = $("#mNickname").val();
                $.post("/user/checkName",{registerName:name},function (data) {
                    if (data){
                        //用户名存在，提示更换
                        $("#span").html("昵称已存在");
                    }else{
